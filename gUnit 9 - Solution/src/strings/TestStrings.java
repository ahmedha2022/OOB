...
public class TestStrings {
	...
	public static void main(String[] args)
	{
		...
		else System.out.println("They are NOT equal using \"EQUALS\"");
		...
		//uncomment code below to see answer:
		  ...
		  StringBuilder bee = new StringBuilder(); 
		  Scanner in = new Scanner(System.in); //only used to make the demo below interactive 
		  for (int i = 0; i<71; i++) {
			  bee.append("a"); 
			  //in.nextLine(); 
			  System.out.println("Length is: " + bee.length() + " capacity: " + bee.capacity()); 
		  }
