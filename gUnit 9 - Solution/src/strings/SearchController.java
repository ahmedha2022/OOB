...
public class SearchController {
    ...
    void search(ActionEvent event) {
    	...
    	int location = story.indexOf(keyword, textArea.getCaretPosition());
    	System.out.println("I found it at: " + location);
    	
    	textArea.selectRange(location, location+keyword.length());
